...
class BNN(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.log_dict({f"train_{k}": v for k, v in logs.items()}, on_step=True, on_epoch=True, sync_dist=True)
        return loss
    ...
    def configure_optimizers(self):
        ...
        scheduler = torch.optim.lr_scheduler.StepLR(optimizer, 100, gamma=0.01, verbose=True)
